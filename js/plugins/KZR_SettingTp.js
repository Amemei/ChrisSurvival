...
// 龍尾改造分
// [Version]
// 1.10 2020/07/11 アクター/職業の最大TPと最小TPを
//                 指定分加減するプラグインコマンド追加
//
// [Version]
 ...
 *
 * <龍尾改造>
 * SettingTp maxadd actor 1 50 // アクターID1の最大TPを +50 する
 * SettingTp maxsub actor 1 50 // アクターID1の最大TPを -50 する
 * SettingTp minadd actor 1 50 // アクターID1の最小TPを +50 する
 * SettingTp minsub actor 1 50 // アクターID1の最小TPを -50 する
 * SettingTp maxadd class 1 50 // 職業ID2の最大TPを +50 する
 * SettingTp maxsub class 1 50 // 職業ID2の最大TPを -50 する
 * SettingTp minadd class 1 50 // 職業ID2の最小TPを +50 する
 * SettingTp minsub class 1 50 // 職業ID2の最小TPを -50 する
 *
 */
...
Game_System.prototype.changeTpData = function (args) {
    if (args[1] === 'actor') {
        ...
        } else if (args[0] == 'maxadd') {
            this._actorTp[args[2]][1] += parseInt(args[3]);
        } else if (args[0] == 'maxsub') {
            this._actorTp[args[2]][1] -= parseInt(args[3]);
        } else if (args[0] == 'minadd') {
            this._actorTp[args[2]][0] += parseInt(args[3]);
        } else if (args[0] == 'minsub') {
            this._actorTp[args[2]][0] -= parseInt(args[3]);
        }
